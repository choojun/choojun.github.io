...
If you are using Apple machines (MacBooks and iMacs with Intel/Apple Silicon processor), you may need to install Fusion Pro (Free for personal use) to virtualize Ubuntu 22.04.x. You can find the specific OS installer at https://ubuntu.com/download/alternative-downloads. After completing the OS setup, follow the same instructions in Sections E to Z to set up the required environment.

...
Experimental Version (not stable yet)
...
1. Start both DFS and YARN services. Ensure both websites http://localhost:9870/ and http://localhost:8088/ are up and ready. Six services (order is not important) can be observed using command jps in this step, i.e. Jps, DataNode, NameNode, SecondaryNameNode, NameManager and ResourceManager processes. Then, your WSL distro is ready for your daily practical exercises :D
~~~bash
      $ cd ~/hadoop3
      $ sbin/start-dfs.sh
      $ sbin/start-yarn.sh

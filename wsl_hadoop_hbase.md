...
~~~
> Reinstall the Kafka if it is not those version of your install Scala, say 2.13.x as shown in file kafka_(Scala-version)-<(afka-version).*. Remember to delete the existing kafka directory before begin your setup.
